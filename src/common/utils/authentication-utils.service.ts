...
export class AuthenticationUtils {
    ...
    public verifyBearerToken(bearerToken: string, cb: VerifyCallback) {
    ...
    public verifyAuthorizationHeader(authorizationHeader: string) {
        return new Promise((resolve, reject) => {
            const tokenProvided = this.verifyBearerToken(authorizationHeader, (err: VerifyErrors, decoded: object | string) => {
                if (err) {
